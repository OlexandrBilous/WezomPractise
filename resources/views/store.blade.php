    ...
    <div class="dx-box bg-white">
        <div class="container">
            <ul class="dx-links dx-isotope-filter text-center">
                ...
                <li data-filter=".template">Templates</li>
                <li data-filter=".plugin">Plugins</li>
            </ul>
        </div>
    </div>
    ...
    <div class="dx-box-5 pb-100 bg-grey-6">
        <div class="container">
            <div class="row vertical-gap dx-isotope-grid">
                ...
                <div class="col-12 col-md-6 col-lg-4 dx-isotope-grid-item theme">
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
        ...
        <span class="dx-portfolio-item-price">$59</span>
                ...
                <div class="col-12 col-md-6 col-lg-4 dx-isotope-grid-item template">
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
        ...
        <span class="dx-portfolio-item-price">$99</span>

    </a>
</div>

                </div>
                <div class="col-12 col-md-6 col-lg-4 dx-isotope-grid-item plugin">
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
        ...
        <span class="dx-portfolio-item-price">$30</span>
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
        ...
        <span class="dx-portfolio-item-price">$23</span>
...
<div class="dx-portfolio-item dx-block-decorated">
    ...
    <a href="product.blade.php" class="dx-portfolio-item-info">
        ...
        <span class="dx-portfolio-item-price">Free</span>
