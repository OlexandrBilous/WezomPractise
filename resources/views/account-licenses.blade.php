                ...
                <div class="dx-box-decorated">
                    <div class="table-responsive">
                        <table class="dx-table dx-table-default">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row" class="dx-table-default-product">
                                        <a href="product.blade.php">Quantial – Moving Upon Signs Moveth Lesser</a>
                                    </th>
                                    <td class="dx-table-licenseKey">98vbjy-t46879ug-fd9iytvh-578g0-8ubfyj00</td>
                                    <td>Standard</td>
                                    <td class="dx-table-website dx-table-default-website"><a href="#">https://example.info/</a></td>
                                    <td>21.07.2018</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="dx-table-default-product">
                                    ...
                                    <td class="dx-table-licenseKey">98vbjy-t46879ug-fd9iytvh-578g0-8ubfyj00</td>
                                    <td>Extended</td>
                                    <td class="dx-table-website dx-table-default-website">Not activated</td>
                                    <td>18.07.2018</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="dx-table-default-product">
                                    ...
                                    <td class="dx-table-licenseKey">98vbjy-t46879ug-fd9iytvh-578g0-8ubfyj00</td>
                                    <td>Standard</td>
                                    <td class="dx-table-website dx-table-default-website"><a href="#" class="dx-btn dx-btn-md dx-btn-grey-2">Deactivate</a></td>
                                    <td>18.07.2018</td>
                                </tr>
                                <tr>
                                    <th scope="row" class="dx-table-default-product">
                                        <a href="product.blade.php">Desty – She'd Under Light Over Multiply Stars Winged</a>
                                    </th>
                                    <td class="dx-table-licenseKey">98vbjy-t46879ug-fd9iytvh-578g0-8ubfyj00</td>
                                    <td>Extended</td>
                                    <td class="dx-table-website dx-table-default-website">Not activated</td>
                                ...
                                <tr>
                                    <th scope="row" class="dx-table-default-product">
                                        <a href="product.blade.php">Silies – Grass Living Fly Subdue After Fruitful</a>
                                    </th>
                                    <td class="dx-table-licenseKey">98vbjy-t46879ug-fd9iytvh-578g0-8ubfyj00</td>
                                    <td>Extended</td>
                                    <td class="dx-table-website dx-table-default-website">Not activated</td>
