...
<head>
    ...
    <title>Amdesk | Submit Ticket</title>
...
<!-- END: Breadcrumbs -->
                    ...
                    <div class="dx-box-content">
                        <form action="#" class="dx-form">
                            ...
                            <div class="dx-form-group">
                                <a href="ticket-submit-2.blade.php" class="dx-btn dx-btn-block dx-btn-xl dx-btn-envato d-flex align-items-center justify-content-center">
