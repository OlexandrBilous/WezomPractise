...
<div class="dx-box bg-white">
    <div class="container">
        <ul class="dx-links text-center">
            ...
            <li class="active"><a href="forums.blade.php">Forums</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="dx-table dx-table-default">
                                ...
                                <tbody>
                                    <tr>
                                        <th scope="row">
                                            <a href="topics.blade.php" class="dx-table-default-title">Design with pleasure</a>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <a href="topics.blade.php" class="dx-table-default-title">Web Design Jobs & Developer Jobs</a>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <a href="topics.blade.php" class="dx-table-default-title">Group Testing</a>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <a href="topics.blade.php" class="dx-table-default-title">Upcomming Features</a>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <a href="topics.blade.php" class="dx-table-default-title">Web Designer Forum News</a>
