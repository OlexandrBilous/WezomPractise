...
<head>
    ...
    <title>Amdesk | Knowledge Base - Single Article Category</title>
...
<div class="dx-article dx-article-block">
    <h4 class="h6 dx-article-title"><a href="single-article.blade.php">Make menu dropdown working without JavaScript</a></h4>
    ...
    <a href="single-article.blade.php" class="dx-btn dx-btn-link d-flex dx-article-link">Read More <span class="icon pe-7s-angle-right"></span></a>
</div>


<div class="dx-article dx-article-block">
    <h4 class="h6 dx-article-title"><a href="single-article.blade.php">Google Analytics</a></h4>
    <div class="dx-article-text">
...
<div class="dx-article dx-article-block">
    <h4 class="h6 dx-article-title"><a href="single-article.blade.php">How to manually import Demo data (if you faced with problems in one-click demo import)</a></h4>
    <div class="dx-article-text">
...
<div class="dx-article dx-article-block">
    <h4 class="h6 dx-article-title"><a href="single-article.blade.php">WordPress Themes FAQ</a></h4>
    <div class="dx-article-text">
