...
<div class="dx-box bg-white">
    <div class="container">
        <ul class="dx-links text-center">
            <li class="active"><a href="help-center.blade.php">Support Home</a></li>
...
<div class="dx-feature dx-feature-3 dx-feature-color-1 dx-block-decorated">
    ...
    <div class="dx-feature-cont">
        <div class="dx-feature-title"><a href="documentations.blade.php">Documentations</a></div>
        <div class="dx-feature-text">Phasellus interdum est diam, eu varius odio tincidunt eget ultrices et</div>
        <a href="documentations.blade.php" class="dx-btn dx-btn-link d-flex dx-feature-link">Read More <span class="icon pe-7s-angle-right"></span></a>
    </div>
</div>
...
<div class="dx-feature dx-feature-3 dx-feature-color-2 dx-block-decorated">
    ...
    <div class="dx-feature-cont">
        <div class="dx-feature-title"><a href="articles.blade.php">Knowledge Base</a></div>
        <div class="dx-feature-text">Aliquam id nisi sit amet massa mollis lobortis interdum felis integer at arcu mattis</div>
        <a href="articles.blade.php" class="dx-btn dx-btn-link d-flex dx-feature-link">Read More <span class="icon pe-7s-angle-right"></span></a>
    </div>
</div>
...
<div class="dx-feature dx-feature-3 dx-feature-color-3 dx-block-decorated">
    ...
    <div class="dx-feature-cont">
        ...
        <div class="dx-feature-text">Sed eget nibh justo euismod maximus et vel nisl pellentesque suscipit nisi</div>
...
<div class="dx-feature dx-feature-3 dx-feature-color-4 dx-block-decorated">
    ...
    <div class="dx-feature-cont">
        <div class="dx-feature-title"><a href="ticket.blade.php">Ticket System</a></div>
        <div class="dx-feature-text">Vivamus sceleriue libero velit blandit, hendrerit nisl at,dapibus sollicitudin</div>
        <a href="ticket.blade.php" class="dx-btn dx-btn-link d-flex dx-feature-link">Read More <span class="icon pe-7s-angle-right"></span></a>
    </div>
</div>
     ...
     <div class="swiper-wrapper">
         <div class="swiper-slide">
             <div class="dx-article dx-article-list">
                 ...
                 <ul class="dx-list">
                    <li><a href="single-article.blade.php">Make menu dropdown working without JavaScript</a></li>
                    <li><a href="single-article.blade.php">Google Analytics</a></li>
                    <li><a href="single-article.blade.php">How to manually import Demo data (if you faced with problems in one-click demo import)</a></li>
                 </ul>
             </div>
         </div>
         <div class="swiper-slide">
             <div class="dx-article dx-article-list">
                 ...
                 <ul class="dx-list">
                    <li><a href="single-article.blade.php">WordPress Themes FAQ</a></li>
                    <li><a href="single-article.blade.php">Change navbar background color</a></li>
                    <li><a href="single-article.blade.php">Change images and banners overlay color</a></li>
                 </ul>
             </div>
         </div>
         <div class="swiper-slide">
             <div class="dx-article dx-article-list">
                 ...
                 <ul class="dx-list">
                    <li><a href="single-article.blade.php">Add top menu link inside dropdown on mobile devices</a></li>
                    <li><a href="single-article.blade.php">Google Map API Warning (NoApiKeys)</a></li>
                    <li><a href="single-article.blade.php">Make dropdown items links working</a></li>
                 </ul>
             </div>
         </div>
     </div>
