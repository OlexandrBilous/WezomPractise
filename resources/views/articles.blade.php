...
<head>
    ...
    <title>Amdesk | Knowledge Base - How can we help you?</title>
    ...
    <div class="dx-box bg-white">
        <div class="container">
            <ul class="dx-links text-center">
                ...
                <li class="active"><a href="articles.blade.php">Knowledge Base</a></li>
...
<div class="dx-article dx-article-list">
    ...
    <a href="single-article-category.blade.php" class="dx-btn dx-btn-xs dx-btn-grey-1 dx-article-btn">4 Articles</a>
</div>
...
<div class="dx-article dx-article-list">
    ...
    <ul class="dx-list">
        ...
        <li><a href="single-article.blade.php">Make menu dropdown working witho</a></li>
...
<div class="dx-article dx-article-list">
    ...
    <a href="single-article-category.blade.php" class="dx-btn dx-btn-xs dx-btn-grey-1 dx-article-btn">8 Articles</a>
</div>
...
<div class="dx-article dx-article-list">
    ...
    <a href="single-article-category.blade.php" class="dx-btn dx-btn-xs dx-btn-grey-1 dx-article-btn">2 Articles</a>
</div>
...
<div class="dx-article dx-article-list">
    ...
    <a href="single-article-category.blade.php" class="dx-btn dx-btn-xs dx-btn-grey-1 dx-article-btn">3 Articles</a>
</div>
...
<div class="dx-article dx-article-list">
    ...
    <ul class="dx-list">
        ...
        <li><a href="single-article.blade.php">How to open image by click on slider</a></li>
...
<div class="dx-article dx-article-list">
    ...
    <a href="single-article-category.blade.php" class="dx-btn dx-btn-xs dx-btn-grey-1 dx-article-btn">1 Articles</a>
</div>
